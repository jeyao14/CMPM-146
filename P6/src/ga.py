    ...
    def mutate(self, genome):
        ...
        for y in range(height):
            for x in range(left, right):
                ...
                #only generate enemies over ground
                if genome[y][x] == "E":
                    if genome[y+1][x] != "X" and genome[y+1][x] != "B" and genome[y+1][x] != "T":
                        genome[y][x] == "-"
                ...
                if (y-3 > 0):
                    if genome[y][x] == "X" and  genome[y][x+1] == "X":
                        if genome[y-1][x] != "|" and genome[y-1][x] != ["T"] and genome[y-1][x+1] != "|" and genome[y-1][x+1] != ["T"] :
                            rand = random.random()
                            if rand < 0.05:
                                genome[y-1][x+1] = "|"
                                if random.random() < 0.5:
                                    ...
                                    genome[y-2][x+1] = "T"
                            elif rand >= 0.05 and rand < 0.1:
                                genome[y-1][x+1] = "T"
                            elif rand >= 0.1:
                                genome[y-1][x+1] = "-"
                
                #removes floating pipes
                if (y+1 < height):
                    if genome[y][x] == "|":
                ...
                #removes blocks that would clip with pipe
                if genome[y][x] == "|":
                    genome[y][x+1] = "-"
                if genome[y][x] == "T":
                    genome[y][x+1] = "-"
...
def generate_successors(population):
    ...
    for element in population:
        level = element.generate_children(population[random.randint(0, len(population)-1)])
